...
export class EnhancedSearchService {
	...
	async updateDocumentEmbeddings() {
		...
		console.log(
			`[SearchService] Updated embeddings for ${documents.length} documents`,
		);
	}
