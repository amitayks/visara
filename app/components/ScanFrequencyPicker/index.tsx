...
export function ScanFrequencyPicker({
	...
	const selectedOption = SCAN_FREQUENCY_OPTIONS.find(option => option.value === value);
				...
				<View style={styles.modalContainer}>
					...
					<ScrollView style={styles.optionsList} showsVerticalScrollIndicator={false}>
						<Text style={styles.sectionDescription}>
							Choose when Visara should automatically scan your gallery for new documents.
						</Text>
									...
									<View style={styles.optionLeft}>
										<View style={[
											...
											<Icon
												name={option.icon}
												size={24}
												color={value === option.value ? theme.background : theme.primary}
											/>
										</View>
										<View style={styles.optionTextContainer}>
											<View style={styles.optionTitleRow}>
												<Text style={[
													styles.optionTitle,
													value === option.value && styles.selectedOptionTitle,
												]}>
													{option.label}
												</Text>
												{option.badge && (
													<View style={[
														...
														<Text style={[
															...
															value === option.value && styles.selectedBadgeText,
														]}>
															{option.badge}
														</Text>
													</View>
						...
						<View style={styles.infoSection}>
							<View style={styles.infoItem}>
								...
								<Text style={styles.infoText}>
									You can change this setting at any time. Battery usage varies by frequency.
								</Text>
							</View>
						</View>
					</ScrollView>
