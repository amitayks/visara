		...
		try {
			if (useMLKit) {
				...
				const processingResult =
					await documentProcessor.processImage(selectedImage);
				...
				const metadata = await documentDetector.extractMetadata(
					ocr,
					detection.type,
				);
			...
			return (
				<View style={styles.resultContainer}>
					...
					<Text style={styles.hintText}>
						Note: ML Kit OCR requires a development build. If using Expo Go,
						switch to "Mock OCR" mode.
					</Text>
				</View>
			);
		}
			...
			<ScrollView style={styles.resultContainer}>
				<View style={styles.section}>
					...
					<Text style={styles.resultText}>
						Type: {result.detection?.type || "Unknown"}
					</Text>
					<Text style={styles.resultText}>
