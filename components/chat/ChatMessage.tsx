...
export const ChatMessage: React.FC<ChatMessageProps> = ({ message, onDocumentPress }) => {
  const isUser = message.user;
  const isRTL = message.isRTL || (message.text && /[\u0590-\u05FF]/.test(message.text));
    ...
    >
      ...
      <View style={styles.documentInfo}>
        <View style={styles.documentHeader}>
          <Text style={styles.documentType}>{doc.documentType.toUpperCase()}</Text>
          {doc.confidence && (
